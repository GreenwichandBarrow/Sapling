...
**Sunday night (automated):** Codex surfaces next 2-4 weeks of conference options. Kay reviews Monday morning during travel to conference and picks next week's.
...
**Next morning:** Codex processes Granola transcripts + Kay's notes. Hands conversation data to outreach-manager's conference outreach subagent for follow-up drafting. Adds contacts to Attio.
...
2. **Manual notes** — Kay texts or types names/companies/notes to Codex after the event
3. **Business cards** — Kay photographs and shares

**Next morning:** Codex processes Granola transcripts + Kay's notes, then passes conversation data to outreach-manager's conference outreach subagent for follow-up drafting.
...
- **Things you might have missed** — Codex flags anything from Granola transcripts that Kay didn't explicitly note (names mentioned in passing, intros promised, business details shared)
