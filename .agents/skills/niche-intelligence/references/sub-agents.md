...
TEMPLATE REFERENCE:
Read: .agents/skills/niche-intelligence/references/one-pager-template.md
...
READ THESE FILES:
- .agents/skills/niche-intelligence/references/scorecard-structure.md (CRITICAL — scoring criteria)
...
READ: .agents/skills/niche-intelligence/references/tracker-access.md
