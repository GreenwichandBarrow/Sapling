...
**Purpose:** Load project context fresh in a new Codex session. Breaks out of local optima by starting with clean context.
...
The phrase "Use ultrathink" in prompts signals to Codex that deep, extended reasoning is expected. This encourages:
