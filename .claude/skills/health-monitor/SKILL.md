...
<objective>
Detect silent failures before they become lost deals or broken workflows. Every issue found in production this month (intermediary-manager failing silently, Project Restoration skipping stages, E&K deal untracked, Superhuman drafts routing to Gmail) would have been caught by this skill.
</objective>
...
**Launchd Jobs:**
Expected jobs:
- `com.greenwich-barrow.intermediary-manager` (Mon-Fri 6am)
...
|-----------|--------|--------|
| intermediary-manager | RED | Exit code 126, permission error since 3/23 |
| ... | ... | ... |
...
| Incident | Check | How |
|----------|-------|-----|
| intermediary-manager exit 126 | Infrastructure → launchd | Non-zero exit code flagged RED |
