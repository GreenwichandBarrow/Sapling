...
date: 2026-05-22
type: brief
title: "Investor Call Prep: Jeff Stevens, Monthly (Call #5)"
people: ["[[entities/jeff-stevens]]", "[[entities/kay-schneider]]"]
companies: ["[[entities/anacapa-partners]]", "[[entities/greenwich-and-barrow]]"]
tags:
  - date/2026-05-22
  - brief
  - person/jeff-stevens
  ...
  - topic/dealsx-windown
  - topic/jj-windown
  - source/claude
---

Jeff Stevens Call Prep. 5/27/26
Monthly cadence, Call #5. 35 days since 4/22. Jeff = lead and largest LP at Anacapa.
...
7. Specialty Insurance Brokerage (Art & Collectibles) — Active Long-Term
...
Wind down DealsX + JJ cleanly by late June.
Stand up the AI drafting skill as the daily inbox layer so middle-of-funnel conversion stops bottlenecking.
Activate buckets 2 and 3 (adjacent staple-female-skew industries) by end of Q2.

Upcoming.
Quarterly investor update (Q1 wrap) going out this week — purpose-throughline framing, Q1 as infrastructure capex, deployment starts Q2. Jeff sees the deck as part of the all-12 send.
DealsX + JJ 30-day notices this week.
Bucket-1 pest warm-intro activation (Black Widow / Citiwide / Excel).
Next 1:1s: Guillermo biweekly, ongoing WSN, Anacapa Friday webinars.
...
Friday webinars continuing per Jeff's 4/22 endorsement. Summit takeaway for Jeff's 4/22 ask: the middle-of-search pattern Jeff named ("you're as effective as you're going to be, lean into pattern recognition") matches what Sam and Will & Jay surfaced at the summit. Net pattern: searchers who close in year 2 tend to be the ones who narrow rather than broaden. That observation is what drove the bucket-of-10 methodology rediscovery.
