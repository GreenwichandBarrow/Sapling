...
| 4 | **M&A Analytics** | Activity rollups — daily / weekly / quarterly / LTD. **Replaces Weekly Activity Tracker Google Sheet** once weekly-view ships. Hosts outbound funnel stats + AI-classified response data + sentiment breakdown (DealsX integration live **May 7, 2026** — see scope below). Reference mockup: `dashboard/mockup-ma-analytics.html`. | Weekly for core metrics |
