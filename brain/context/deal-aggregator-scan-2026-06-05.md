...
dealsx_replies: 0
buy_box_source: live
email_scan_source: missing
---
# Deal Aggregator Scan — 2026-06-05

Morning run (full). Buy-box docs read live from Drive. Active niches loaded from WEEKLY REVIEW. DEALSX keyword corpus loaded and resolved for all 8 active niches. Email-scan-results artifact was missing for 2026-06-05, so email-routed sources were scorecarded but no email listings were parsed.
...
1. **Lead Generation Marketplace for Local Service Pros** — Website Closers | Revenue: $9.6M | EBITDA: $2.37M cash flow | Match type: Buy-box match, new niche | https://www.websiteclosers.com/businesses/lead-generation-marketplace-for-local-service-pros-cpl-saas-models-200-000-active-lead-buyers-10-premium-domains-massive-yoy-growth/118958/

## Email Inbound Deals

None today. `brain/context/email-scan-results-2026-06-05.md` was missing at scan time, so email-only broker sources were logged in the Source Scorecard with zero parsed listings.
...
None today. Email-scan-results artifact missing; no DealsX reply notifications were available to parse.

## Near Misses (not Slacked)

- **GovCon IT Firm — 120M+ in Judiciary & VA Contracts** (Business Exits) — $19.7M revenue, $3.4M income, 17.5% margin. Clears Services financial gate; no active-niche corpus match.
- **B2B Experiential Marketing Vendor** (Business Exits) — $14.3M revenue, $3.3M income, 23.1% margin. Clears Services financial gate; no active-niche corpus match.
- **Government Contract ERP Service Business** (Business Exits) — $14.0M revenue, $2.6M income, 18.3% margin. Clears Services financial gate; no active-niche corpus match.
- **Multi-Service Oilfield Infrastructure & Automation Company** (Business Exits) — $12.9M revenue, $2.0M income, 15.3% margin. Clears financial gate; no active-niche corpus match; industrial field-services review item.
- **Growing LED Display Solutions Company** (Synergy Business Brokers) — FL, $11.2M revenue, $4.6M EBITDA, 41.4% margin. Clears Services financial gate; no active-niche corpus match.
- **Email scan gap** — `email-scan-results-2026-06-05.md` missing. Email-only sources could not be parsed this run.
...
| Business Exits | GovCon IT Firm – 120+ Million in Judiciary & VA-Focused Contracts | undisclosed | $19,700,595 | $3,446,340 | 17.5% | B2B IT Services / GovCon | NEAR-MISS | Passes financial gate; no active niche corpus match |
| Business Exits | B2B Experiential Marketing Vendor | undisclosed | $14,277,492 | $3,297,944 | 23.1% | B2B Marketing Services | NEAR-MISS | Passes financial gate; no active niche corpus match |
| Business Exits | Government Contract ERP Service Business | undisclosed | $14,046,972 | $2,572,171 | 18.3% | B2B ERP / GovCon | NEAR-MISS | Passes financial gate; no active niche corpus match |
| Business Exits | Multi-Service Oilfield Infrastructure & Automation Company | undisclosed | $12,897,728 | $1,967,502 | 15.3% | B2B Oilfield Services | NEAR-MISS | Passes financial gate; no active niche corpus match |
| Synergy Business Brokers | Growing LED Display Solutions Company | Florida | $11,193,625 | $4,634,729 | 41.4% | B2B Technology / Distribution | NEAR-MISS | Passes financial gate; no active niche corpus match |
...
| Flippa | General | active (email-routed; email artifact missing) | n/a | 0 | 0 | — |
| IAG M&A Advisors | General | active (email-routed; email artifact missing) | n/a | 0 | 0 | — |
| Quiet Light | General | active (email-routed; email artifact missing) | n/a | 0 | 0 | — |
...
| Viking Mergers | General | active (email-routed; email artifact missing) | n/a | 0 | 0 | — |
...
**Notes:**
- BizBuySell: primary fetch returned 403. `agent-browser` is not installed on this host, so fallback was unavailable; marked `blocked (single-attempt)`.
- Email-routed active sources: email-scan-results artifact missing, so no broker blasts, CIMs, NDA requests, or DealsX owner replies were available to parse.
- Website Closers: 1 new match posted to #active-deals; fingerprint added to `deal-aggregator-fingerprints.jsonl`. Matches count now includes the 2026-06-03 prop-trading SaaS match and today's lead-generation marketplace match.

## Volume Check

- Deals surfaced today: 1
- Prior 6 weekday morning runs: 0, 0, 0, 0, 1, 0
