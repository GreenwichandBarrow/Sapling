...
## Quick Facts
- Active Deals pipeline (Attio list) — stage: Identified since 2026-03-14
- Location: New York, New York
- Employee range: 11-50
- ARR bucket: $1M-$10M
- Category: Insurance / Marketplace

## Communication Style
- **Tone:** TBD — fill on first owner call
- **Format:** TBD
- **Frequency:** TBD

## Key Context
- Stage is "Identified" but last_interaction logged 2026-03-31 — process anomaly: outreach occurred without stage advance to Contacted.
- Stub created during 2026-05-01 stale-pipeline walk.
