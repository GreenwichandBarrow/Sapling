...
This buy box applies ONLY to broker-channel and intermediary-curated deal flow. Proprietary outreach (G&B direct cold outreach, JJ-Call-Only) continues to run on the niche-strict thesis buy boxes (Services, Insurance, SaaS).
...
This buy box is the screen for these source types in the deal-aggregator Sourcing Sheet:
