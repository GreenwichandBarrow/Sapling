...
- Review the remaining scheduled/core skill prompts one by one for semantic fidelity, especially `email-intelligence`, `relationship-manager`, `health-monitor`, `launchd-debugger`, and weekly/nightly tracker workflows.
