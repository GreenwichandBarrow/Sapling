---
name: Kay handles all email replies personally — never automate reply correspondence
description: All replies (Kay-sent or Sam-DealsX-sent) route to Kay via dashboard. Reply handling is Kay's job; never propose automated reply sequences or AI-drafted reply chains.
type: feedback
...
1. **When proposing any outbound campaign (Kay-sent or DealsX-sent):**
   - The send-vs-draft question is about who *sends* the initial outreach
   - The reply question is settled: **Kay handles replies, always**
   - Don't ask Kay "who handles replies" — that's not a decision Kay makes per campaign

2. **For DealsX (Sam-sent) campaigns:**
   - Replies arrive in the dashboard
   - Kay sees them directly
   - Don't draft auto-replies, don't suggest Sam handle objection-handling, don't propose templated reply sequences

3. **For Kay-sent campaigns (Gmail directly):**
...
**Source:** Kay 2026-04-29 conversation: "all of the replies from Sam's emailing come to me directly in the dashboard. I always handle the replies."
