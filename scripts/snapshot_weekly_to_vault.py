...
def _format_markdown(snap: dict) -> str:
    ...
    lines.extend([
        ...
        "## System Throughput",
        "",
        f"- Outreach sends: {metrics['outreach_sends_this_week']} this week ({_delta_str(metrics['outreach_sends_this_week'], metrics['outreach_sends_prior_week'])} vs prior week).",
        f"- Drafts created: {metrics['drafts_this_week']} this week ({_delta_str(metrics['drafts_this_week'], metrics['drafts_prior_week'])} vs prior week).",
        f"- Operations dials: {metrics['ops_dials_this_week']} this week ({_delta_str(metrics['ops_dials_this_week'], metrics['ops_dials_prior_week'])} vs prior week).",
        "",
        "## Signal Quality",
        "",
        f"- Owner conversations: {metrics['owner_conversations']}",
